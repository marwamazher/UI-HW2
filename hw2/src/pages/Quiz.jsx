...
// quiz page to determine best acitivity
const Quiz = ({ onResult }) => {
  ...
  // handle selection of answers when user clicks on an option
  ...
  const handleSubmit = () => {
    ...
    // check is any questions are not answered
    if (incomplete) {
    ...
    // initialise points for each category
    const points = {
      Theatre: 0,
      Art: 0,
      History: 0,
    ...
    // handle tied categories by selecting random
    ...
    // redirect to the art-and-culture page with the recommended category
  ...
  return (
    <>
      <div className='quiz'>
        ...
        {/* questions and answers mapped to their categories */}
        <div>
